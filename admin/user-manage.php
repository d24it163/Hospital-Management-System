...
<!DOCTYPE HTML>
	<html>
	<head>
		<title>Manage User | Divyam Hospital</title>
						...
						<div class="main-page">
							<div class="tables">
								...
								<button type="submit" name="submit" class="btn btn-default right"
									style="background-color:rgba(97, 100, 193, 0.85);color:#fff;margin-left: 95%;"><a
									...
									<table class="table table-bordered">
										...
										<tbody>
											...
											while ($row = mysqli_fetch_array($query)) {
												...
												echo "<td> <a href='user-edit.php?id=$row[id]'><i class='bx bxs-edit'></i>
															</a> |

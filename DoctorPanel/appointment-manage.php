...
<!DOCTYPE HTML>
	<html>
	<head>
		<title>Appointment Manage| Divyam Hospital</title>
									...
									<table class="table table-bordered">
										...
										<tbody>
											...
											while ($row = mysqli_fetch_array($query)) {
												...
												echo "<td> <a href='appointment-edit.php?id=$row[id]'><i class='bx bxs-edit'></i>
                                                </a> |
												<a href='deleteappointment.php?id=$row[id]'><i class='bx bxs-trash'  ></i>
												</a>
														</td>
												</tr>";
